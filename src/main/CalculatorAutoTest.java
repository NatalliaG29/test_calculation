...
public class CalculatorAutoTest {
    ...
    public void cleanWindow() {
        WebElement cleanWindow = driver.findElement(By.xpath(
                "//android.widget.ImageButton[@content-desc=\"clear\"]"));
        cleanWindow.click();
    }

    public void moreOptions() {
        WebElement buttonMoreOptions = driver.findElement(By.xpath(
    ...
    public void shoulSuccessfullyMultiplyTest() {
        ...
        WebElement buttonMultiply = driver.findElement(By.xpath(
                "//android.widget.ImageButton[@content-desc=\"multiply\"]"));
        buttonMultiply.click();

        WebElement buttonFive = driver.findElement(By.id("com.google.android.calculator:id/digit_5"));
        buttonFive.click();

        WebElement buttonEquals = driver.findElement(By.xpath(
                "//android.widget.ImageButton[@content-desc=\"equals\"]"));
        buttonEquals.click();

        String multiplicationResult = driver.findElement(By.id(
    ...
    public void shouldSuccessfullyRootCalculationTest() {
        ...
        String rootCalculationResult = driver.findElement(By.id(
                "com.google.android.calculator:id/result_final")).getText();
        cleanWindow();
    ...
    public void shouldDivisionByZeroTest() {
        ...
        WebElement buttonDivide = driver.findElement(By.xpath(
        ...
        String divisionByZeroResult = driver.findElement(By.id(
                "com.google.android.calculator:id/result_preview")).getText();
        cleanWindow();
    ...
    public void shouldCosineСalculationTest() {
        WebElement buttonExpand = driver.findElement(By.xpath(
                "//android.widget.ImageButton[@content-desc=\"Expand\"]"));
        buttonExpand.click();

        WebElement buttonCosine = driver.findElement(By.xpath(
                "//android.widget.ImageButton[@content-desc=\"cosine\"]"));
        buttonCosine.click();

        WebElement buttonNine = driver.findElement(By.id(
                "com.google.android.calculator:id/digit_9"));
        buttonNine.click();

        WebElement buttonEight = driver.findElement(By.id(
        ...
        String cosineСalculationResult = driver.findElement(By.id(
                "com.google.android.calculator:id/symbolic")).getText();
        cleanWindow();
        Assertions.assertEquals("-sin(8)", cosineСalculationResult);

        WebElement buttonCollapse = driver.findElement(By.xpath(
    ...
    public void shouldOpenHistoryTabTest() {
        ...
        for (String contextName : HistoryTab) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath(
                        "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget" +
                                ".ListView/android.widget.LinearLayout[1]/android.widget.LinearLayout")).click();
            }
        }

        String openHistoryTabResult = driver.findElement(By.xpath(
                "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget" +
                        ".FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view" +
                        ".ViewGroup/android.widget.LinearLayout[1]/android.view" +
                        ".ViewGroup/android.widget.TextView")).getText();
    ...
    public void shouldChooseThemeTest() {
            ...
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath(
                        "/hierarchy/android.widget.FrameLayout/android.widget." +
                                ...
                                ".widget.FrameLayout/android.support.v7.widget.LinearLayoutCompat/android.widget" +
            ...
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath(
                        "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android" +
                                ...
                                ".support.v7.widget.LinearLayoutCompat/android.widget.ScrollView/android.widget" +
        ...
        for (String contextName : themeCheck) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath(
                        "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android" +
                                ".widget.ListView/android.widget.LinearLayout[2]/android.widget.LinearLayout")).click();
            }
        }

        WebElement chooseThemeResult = driver.findElement(By.xpath(
                "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget" +
        ...
        for (String contextName : buttonOK2) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath(
                        "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget" +
                                ".FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.support.v7" +
                                ".widget.LinearLayoutCompat/android.widget.ScrollView/android.widget" +
                                ".LinearLayout/android.widget.Button[2]")).click();
            }
        }
    }
    ...
    public void shouldSendFeedbackTest() {
        ...
        for (String contextName : feedbackTab) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath("/hierarchy/android.widget" +
                        ".FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget" +
                        ".LinearLayout[3]/android.widget.LinearLayout")).click();
            }
        }

        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        WebElement editText = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android" +
                ".widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget" +
                ".FrameLayout[2]/android.widget.FrameLayout/android.widget.ScrollView/android.widget" +
                ".FrameLayout/android.widget.LinearLayout/android.widget.EditText"));
        ...
        String sendFeedbackResult = driver.findElement(By.xpath(
                "/hierarchy/android.widget.Toast")).getText();
    ...
    public void shouldOpenArticleTest() {
        ...
        for (String contextName : helpTab) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath("/hierarchy/android.widget" +
                        ".FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget" +
                        ".LinearLayout[4]/android.widget.LinearLayout")).click();
            }
        }

        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        WebElement openArticle = driver.findElement(By.xpath("/hierarchy/android.widget" +
                ".FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget" +
                ".LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android" +
                ".widget.FrameLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget" +
                ".LinearLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget" +
                ".LinearLayout/android.widget.TextView"));
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        openArticle.click();

        String openArticleResult = driver.findElement(By.xpath("/hierarchy/android.widget." +
                "FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget." +
                "LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android" +
                ".widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit" +
                ".WebView/android.view.View/android.view.View/android.view.View/android.view.View/android" +
                ".view.View[1]")).getText();

        WebElement closeArticle = driver.findElement(By.xpath("//android.widget" +
                ".ImageButton[@content-desc=\"Close\"]"));
        closeArticle.click();
    ...
    public void shouldCleanHistoryTest() throws InterruptedException {
        ...
        WebElement buttonMoreOptions = driver.findElement(By.xpath("(//android.widget" +
                ".ImageView[@content-desc=\"More options\"])[1]"));
        buttonMoreOptions.click();
        ...
        for (String contextName : buttonClean) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath("/hierarchy/android.widget" +
                        ".FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget" +
                        ".LinearLayout/android.widget.LinearLayout")).click();
            }
        }
        ...
        for (String contextName : confirmationClean) {
            if (contextName.contains("NATIVE_APP")) {
                driver.context(contextName).findElement(By.xpath("/hierarchy/android.widget" +
                        ...
                        ".FrameLayout/android.widget.FrameLayout/android.support.v7.widget" +
                        ".LinearLayoutCompat/android.widget.ScrollView/android.widget.LinearLayout/android" +
        ...
        String cleanHistoryResult = driver.findElement(By.xpath("/hierarchy/android.widget" +
                ".FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget" +
                ".LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget" +
                ".LinearLayout[1]/android.support.v7.widget.RecyclerView/android.widget" +
                ".FrameLayout/android.widget.TextView")).getText();
